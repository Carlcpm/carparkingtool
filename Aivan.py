...
import secrets
from aivansarte import Rexcpm # Your game logic class

__CHANNEL_USERNAME__ = "AIVANSARTE TERMUX CHANNEL"
__GROUP_USERNAME__   = "AIVANSARTE TERMUX GROUP"
...
def banner(console):
    ...
    console.print("[bold green]♕ AIVAN[/bold green]: Car Parking Multiplayer 2 Hacking Tool.", justify="center")
...
def animated_intro(console):
    title = "[bold cyan]🚀 AIVAN TOOL[/bold cyan]"
    subtitles = [
